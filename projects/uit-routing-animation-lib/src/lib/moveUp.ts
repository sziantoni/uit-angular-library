      ...
      query(':enter' , style({
        ...
        query(':leave', [
          ...
          animate('{{leaveT}}s {{leaveD}}s ease-in', keyframes([
              ...
              style({ transform: 'translateX({{dir}}50%) translateY(0%) scaleY(0.6) scaleX(0.6)' ,  opacity: 0.5,  offset: 0.6}),
              style({ transform: 'translateX({{dir}}50%) translateY(-50%) scaleY(0.5) scaleX(0.5)',   opacity: 0.4,  offset: 0.7 }),
              style({ transform: 'translateX({{dir}}50%) translateY(-100%) scaleY(0.4) scaleX(0.4)', opacity: 0,  offset: 1,  })
            ])
          ) ,
        ...
        query(':enter' , [
          ...
          animate( '{{enterT}}s {{enterT}}s ease-out' , keyframes([
            style({transform: 'translateX({{dir}}50%) translateY(-75%) scaleY(0.4) scaleX(0.4)',  opacity: 0.1,  offset: 0.1}),
            style({transform: 'translateX({{dir}}50%) translateY(-50%) scaleY(0.5) scaleX(0.5)', opacity: 0.2,  offset: 0.2 } ),
            style({ transform: 'translateX({{dir}}50%) translateY(0%) scaleY(0.6) scaleX(0.6)',   opacity: 0.3,  offset: 0.3 }),
        ...
        stagger(150, [
          ...
          animate(
            '{{enterTR}}s {{enterDR}}s ease-out', keyframes([
              style({transform: 'translateX({{dir}}50%) translateY(-50%) scaleY(0.4) scaleX(0.4)',  opacity: 0.1,  offset: 0.1}),
              style({ transform: 'translateX({{dir}}50%) translateY(0%) scaleY(0.7) scaleX(0.7)', opacity: 0.5,  offset: 0.4}),
